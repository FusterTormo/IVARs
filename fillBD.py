        ...
        with open(filename, "r") as fi :
            for l in fi :
                ...
                if len(header) == 0 :
                    ...
                    sumPreds = lib.summaryPredictors(pred_keys, pred_vals)
                    ...
                    popMax, maxMaf = lib.getPopMax(pop_keys, pop_vals)
                    ...
                    if format[0] == "GT" :
                        ...
                        if filter == "PASS" :
                            filter = lib.filtrarVariante(typ, exo, maxMaf, vaf)
                    else :
    ...
    for a in arx :
        if a.endswith("vcf") :
            ...
            if vc == "varscan.vcf" :
                ...
                annoFile = lib.anotarVariante(newf)
